# Dokumentation: JKostenSumme

**Datei:** `a1aeins/fibujpp.cpp`  
**Klasse:** `JKostenSumme`  
**Zweck:** Methoden zum bebuchen der Kostenstellen / KOstenträger /Kostenarten  
...
Methoden zum bebuchen der Kostenstellen / KOstenträger /Kostenarten
